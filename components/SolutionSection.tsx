        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              Clinic Manager bridges the gap between reception, doctor, and pharmacy with a single integrated data flow.
            </p>
          </motion.div>
        </div>

        <div className="bg-primary-600 rounded-[3rem] p-8 lg:p-16 text-white shadow-2xl shadow-primary-200">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-8">
              <h3 className="text-3xl font-bold leading-tight italic">
                Replacing registers with a unified digital ecosystem.
              </h3>
            ...
            <div className="lg:w-1/2 relative">
               <div className="bg-white/10 rounded-[2.5rem] p-8 aspect-video flex items-center justify-center border border-white/20 backdrop-blur-md">
                  <div className="text-center space-y-6">
                    ...
                    <div className="text-sm font-mono tracking-widest text-primary-100">SYNC_ENGINE_ACTIVE v1.0</div>
