    ...
    <footer className="bg-white border-t border-slate-100 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 gap-12">
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-500">
                <li><a href="#docs" className="hover:text-primary-600">Usage Guide</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-400">
          <p>© 2024 Clinic Manager Project. Proprietary Software.</p>
          <p className="flex items-center gap-1">
            Developed with <Heart size={12} className="text-rose-500 fill-rose-500" /> by <span className="text-slate-600 font-bold">algospider</span>
          </p>
        </div>
      </div>
    </footer>
